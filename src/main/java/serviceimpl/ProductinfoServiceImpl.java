...
public class ProductinfoServiceImpl implements ProductinfoService {
    ...
    public List<Productinfo> selectAll() {
        System.out.println(pm.selectAll());
        return pm.selectAll();
    }

    @Override
    public int upProduct(Integer pId) {
        return pm.upProduct(pId);
    }

    @Override
    public int descendProduct(Integer pId) {
        return pm.descendProduct(pId);
    }
}
